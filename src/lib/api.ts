...
export async function updateResolutionSummary(ticketId: string, summary: string) {
...
export async function updatePriority(ticketId: string, priority: TicketPriority) {
...
export async function updateCategory(ticketId: string, category: TicketCategory) {
...
export async function updateOwner(ticketId: string, userId: string) {
  await ghlRequest(`/opportunities/${ticketId}`, {
    method: "PATCH",
...
export async function bulkUpdatePriority(ids: string[], priority: TicketPriority) {
